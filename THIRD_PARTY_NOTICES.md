...
The repository source does not vendor third-party binaries. The version 1.0.7
...
- Corresponding source: attached to the version 1.0.7 release as
  `PrivacyBrowser-1.0.7-myst-lmprove-source-7944a4c.tar.gz`.
