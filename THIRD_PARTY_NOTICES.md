...
The repository source does not vendor third-party binaries. The version 1.0.1
...
- Corresponding source: attached to the version 1.0.1 release as
  `PrivacyBrowser-1.0.1-myst-lmprove-source-227d63b.tar.gz`.
