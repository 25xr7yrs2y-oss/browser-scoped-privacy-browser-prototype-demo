# Version 1.0.7 bundled dependencies

The portable package is assembled without running either upstream installer.
The 1.0.7 controller-only payment architecture update reuses the exact pinned
and verified backend binary shipped by 1.0.6.
